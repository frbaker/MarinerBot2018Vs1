...
public:
	...
	static std::shared_ptr<frc::Ultrasonic> driveBaseUltrasonic;
	static std::shared_ptr<frc::AnalogGyro> driveBaseGyro;
	static std::shared_ptr<WPI_TalonSRX> mastMastTalon;
	static std::shared_ptr<WPI_TalonSRX> elbowElbowTalon;
	...
	static std::shared_ptr<WPI_TalonSRX> climberClimberTalon;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	//static std::shared_ptr<AHRS> driveBaseAhrs;
	static void init();
};
#endif
